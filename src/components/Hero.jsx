          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6">
                <div className="hero-text p-lg-5 p-md-3 p-sm-2">
                    ...
                    <p className='fs-5 text-secondary'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, molestiae eligendi hic nobis aliquam quo consequuntur quis ex laborum ab esse sunt pariatur dolorem excepturi accusamus iusto fuga culpa iure.</p>
